...
public class Test_Maestro_GetBrands extends APITestBase {
    String sHost;
    String sEndpoint;
    ...
    public void getEnvironment(ITestContext testContext) throws IOException {
        sHost = PropertiesHelper
                .getHostStringFromPropertiesFile(sPropertyFileName, Test_Maestro_GetBrands.class);
        sEndpoint = "/admin/client/brand/{mieClientId}";
    }

    @Test(dataProvider = "dataProvider", dataProviderClass = TestDataProvider.class)
    public void getBrands(Map<Object, Object> testData, ITestContext testContext)
            throws IOException {
