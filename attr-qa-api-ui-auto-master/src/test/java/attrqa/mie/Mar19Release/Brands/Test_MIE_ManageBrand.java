...
public class Test_MIE_ManageBrand extends APITestBase {
    String sHost;
    String sEndpoint;
    ...
    public void getEnvironment(ITestContext testContext) throws IOException {
        sHost = PropertiesHelper
                .getHostStringFromPropertiesFile(sPropertyFileName, Test_MIE_ManageBrand.class);
        sEndpoint = "/v2/utilities/Brands/ManageBrand";
    }



    @Test(dataProvider = "dataProvider", dataProviderClass = TestDataProvider.class)
    public void manageBrand(Map<Object, Object> testData, ITestContext testContext)
            throws IOException {
