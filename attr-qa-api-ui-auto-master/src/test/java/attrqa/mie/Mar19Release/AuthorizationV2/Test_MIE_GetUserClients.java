...
public class Test_MIE_GetUserClients extends APITestBase {
    String sHost;
    String sEndpoint;
    ...
    public void getEnvironment(ITestContext testContext) throws IOException {
        sHost = PropertiesHelper
                .getHostStringFromPropertiesFile(sPropertyFileName, Test_MIE_GetUserClients.class);
        sEndpoint = "/v2/authorization/GetUserClients";
    }



    @Test(dataProvider = "dataProvider", dataProviderClass = TestDataProvider.class)
    public void getUserClients(Map<Object, Object> testData, ITestContext testContext)
            throws IOException {
            ...
            for (int i = 0; i < validationNodes.length; i++) {
                ...
                if (sValue.startsWith("[")) {
                    ...
                    if(isExpectedListOfValuesPresent == false)
                    {
                        ...
                        logInfo("Missing ClientKey :: " + listOfComparisonValues1);
                    }
